...
const getAllMyStories = async (
  ...
  SELECT 
      ...
      s.message,
      s.message_size as messageSize,
      s.message_color as messageColor,
      s.message_background as messageBackground,
      s.image,
...
const update = async (updatedStory: StoryType) => {
  ...
  await db.query(sql, [
    ...
    updatedStory.messageSize || null,
    updatedStory.messageColor || null,
    updatedStory.messageBackground || null,
